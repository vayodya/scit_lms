...
<div id="login">
	...
	echo $this->Form->create('leave_record', array(
			'url' => array('action' => 'view_leave_repo')
			));
...
<?php  
    ...
    <tr>
       ...
       <td>  <?php echo $result['leave_record']['EmpName'];  ?></td>
        <td>  <?php echo $result['leave_record']['Leave_Type'];  ?></td>
        <td><?php echo $result['leave_record']['From_Date']; ?></td>
        <td><?php echo $result['leave_record']['To_Date']; ?></td>
        <td><?php echo $result['leave_record']['Leave_Time']; ?></td>
        <td ><?php echo $result['leave_record']['Leave_comment']; ?></td>
        <td><?php echo $result['leave_record']['Leave_states']; }}
...
<font color ="green"> <?php echo 'For Download click this '.$this->Html->link($download_img, array('controller' => 'Contacts','action' =>'download_adminview_leave_filter',$f_date,$t_date,$status), array('escape' => false));?> </font> <?php
        }
?>
</div>
