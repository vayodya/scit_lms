...
<?php
    ...
    echo $this->Form->input('Leave Time',array('options'=>$arrCategory, 'name'=>'Leave_Time','required'=>'required','placeholder'=>'Leave Time','title'=>'Leave Time is required.','empty'=>'-- Select --','selected'=>'Your Value'));
    echo $this->Form->input('Leave Comment', array('type' => 'textarea','name'=>'Leave_comment'));   
