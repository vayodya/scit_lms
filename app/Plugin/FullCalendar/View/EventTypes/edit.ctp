 ...
 */
?>
<div class="eventTypes form " style="margin-left:230px">
<?php echo $this->Form->create('EventType');?>
	<fieldset>
 		<legend><?php echo 'Edit Event Type'; ?></legend>
	<?php
...
<div class="actions" style="margin-top:-16%; position:absolute; width:14%">
	<ul>
